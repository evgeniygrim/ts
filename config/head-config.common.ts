...
export const config = {
  link: [
     ...
     */
    // { rel: 'icon', type: 'image/png', sizes: '384x384', href: '/assets/icon/android-chrome-384x384.png' },
    // { rel: 'icon', type: 'image/png', sizes: '256x256', href: '/assets/icon/android-chrome-256x256.png' },
    // { rel: 'icon', type: 'image/png', sizes: '192x192', href: '/assets/icon/android-chrome-192x192.png' },
    // { rel: 'icon', type: 'image/png', sizes: '144x144', href: '/assets/icon/android-chrome-144x144.png' },
    // { rel: 'icon', type: 'image/png', sizes: '96x96', href: '/assets/icon/android-chrome-96x96.png' },
    // { rel: 'icon', type: 'image/png', sizes: '72x72', href: '/assets/icon/android-chrome-72x72.png' },
    // { rel: 'icon', type: 'image/png', sizes: '48x48', href: '/assets/icon/android-chrome-48x48.png' },
    // { rel: 'icon', type: 'image/png', sizes: '36x36', href: '/assets/icon/android-chrome-36x36.png' },
